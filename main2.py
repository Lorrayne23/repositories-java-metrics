...
def save_file(result):
  ...
  for r in results:
    ...
    data.append([name, url_repo, stargazer_Count, total_releases,age])

  columns = ["Name","Url","Stargazer_Count", "Total Releases","Age"]
  df = pd.DataFrame(data, columns=columns)
  df.to_csv("repositorios_populares_java.csv")
